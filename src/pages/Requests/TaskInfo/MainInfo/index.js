...
export default function MainInfo({
  ...
  const [coordinates] = useState(
    JSON.parse(sessionStorage.getItem("restaurantLocation"))
  );
      ...
      <div className="content">
        ...
        <section className="address">
          {address ? (
            <a
              target="blank"
              href={`https://www.google.com/maps/dir/${coordinates[1]},${coordinates[0]}/${address.location.coordinates[1]},${address.location.coordinates[0]}`}
            >
