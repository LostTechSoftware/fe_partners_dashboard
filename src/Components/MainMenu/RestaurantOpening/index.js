...
export default function RestaurantOpening() {
  ...
  const [expectedDeliveryTime, setExpectedDeliveryTime] = useState(
    sessionStorage.getItem("delay")
  );
  const [expectedWithdrawalTime, setExpectedWithdrawalTime] = useState(
    sessionStorage.getItem("delayToWithdrawal")
  );
  ...
  function controlRestaurantOpening() {
    if (restaurantIsOpen) closeRestaurant();
    else openRestaurant();
  }
  ...
  return (
    <div className="restaurantOpeningBox">
      ...
      <section className="expectedDeliveryTime">
        <label htmlFor="expectedTime">Tempo de entrega estimado</label>/
      ...
      <section className="expectedDeliveryTime">
        <label htmlFor="expectedTime">Tempo estimado para retirada</label>/
